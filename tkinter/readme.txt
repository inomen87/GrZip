This is a language learning app that helps us learn French.
It already works and code is finished.

The principle is the following:
1. French word is shown in window
2. If we know the word in English we press green "🗸" button and word is deleted from a "words_to_learn.csv" file.
